...
#define _loop0_109_type 1267
#define _gather_108_type 1268
#define _tmp_110_type 1269
...
// compound_stmt:
//     | &('def' | '@' | ASYNC | 'function') function_def
//     | &'if' if_stmt
//     | &('class' | '@') class_def
...
compound_stmt_rule(Parser *p)
{
    ...
    { // &('def' | '@' | ASYNC | 'function') function_def
        ...
        D(fprintf(stderr, "%*c> compound_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "&('def' | '@' | ASYNC | 'function') function_def"));
        ...
        D(fprintf(stderr, "%*c%s compound_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "&('def' | '@' | ASYNC | 'function') function_def"));
    }
    { // &'if' if_stmt
        if (p->error_indicator) {
            p->level--;
...
//     | 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
//     | ASYNC 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
static stmt_ty
function_def_raw_rule(Parser *p)
{
    ...
    { // 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        D(fprintf(stderr, "%*c> function_def_raw[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block"));
        Token * _keyword;
        Token * _literal;
        Token * _literal_1;
        Token * _literal_2;
        ...
        void *tc;
        if (
            (_keyword = _PyPegen_expect_token(p, 524))  // token='function'
            &&
            (n = _PyPegen_name_token(p))  // NAME
            &&
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s function_def_raw[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block"));
    }
    { // ASYNC 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        if (p->error_indicator) {
            p->level--;
        ...
        D(fprintf(stderr, "%*c> function_def_raw[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "ASYNC 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block"));
        Token * _keyword;
        Token * _literal;
        Token * _literal_1;
        Token * _literal_2;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s function_def_raw[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "ASYNC 'function' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block"));
    }
    _res = NULL;
  done:
    p->level--;
...
_tmp_15_rule(Parser *p)
{
    ...
    { // 'function'
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_15[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'function'"));
    }
    _res = NULL;
  done:
    p->level--;
